...
<h3>КОМПЛЕКСНИ РАЧУН / BIGINTEGER</h3>
<form id='calculator' name='calculator'>
	<table>
		<tr>
			<td>Први операнд: </td>
			<td><input type='number' name='operand_1_re' value='0'/> + i <input type='number' name='operand_1_im' value='0'/></td>
		</tr>
		<tr>
			<td>Други операнд: </td>
			<td><input type='number' name='operand_2_re' value='0'/> + i <input type='number' name='operand_2_im' value='0'/></td>
		</tr>
		<tr>
			<td>Операција: </td>
			<td>
	...
	<input type='hidden' value='BIGINTEGER' name='calculator_type'/>
